...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="/styles.css?v=20260517-patriot-marquee-restore-2" />
  ...
  <body>
    ...
    <header class="site-header" data-site-header>
      <a class="brand" href="/" aria-label="After Dark Kreations home"><img src="https://d2xsxph8kpxj0f.cloudfront.net/310419663029344895/Y6P4wESsnqturPWjC5KcFB/adk-logo-badge_452696c8.png" alt="After Dark Kreations ADK logo" /><span>After Dark Kreations</span></a>
      <button class="menu-toggle" type="button" aria-expanded="false" aria-controls="primary-navigation"><span></span><span></span><span class="visually-hidden">Open navigation</span></button>
      <nav class="site-nav" id="primary-navigation" aria-label="Primary navigation"><a class="nav-link" href="/">Home</a><a class="nav-link" href="/capabilities">Capabilities</a><a class="nav-link" href="/store">Store</a><a class="nav-link" href="/shop-work">Shop Work</a><a class="nav-link" href="/build-request">Build Request</a><a class="nav-link" href="/about">About</a><a class="nav-link" href="/contact">Contact</a></nav>
      <div class="header-contact"><a href="tel:+17028109021">(702) 810-9021</a><a class="cart-link" href="/cart" aria-label="Open cart"><span data-cart-count>0</span> Cart</a><a class="small-button" href="/build-request">Request a Build</a></div>
    </header>
    <main id="main">
    ...
    ${dataScript}
    <script src="/lib/shopify.js?v=20260517-patriot-marquee-restore-2" defer></script>
    <script src="/script.js?v=20260517-patriot-marquee-restore-2" defer></script>
  </body>
</html>`;
}
